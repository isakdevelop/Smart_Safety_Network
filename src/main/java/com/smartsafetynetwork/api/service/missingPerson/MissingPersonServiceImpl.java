...
public class MissingPersonServiceImpl implements MissingPersonService{
    ...
    @Override
    public ResponseMessage write(MissingPersonWriteRequestDto requestDto) {
        ...
        try {
            ...
            return new ResponseMessage(0, "실종자 신상 등록에 성공하였습니다.");
        } catch (IOException e) {
    ...
    public ResponseMessage delete(RequestId requestId) {
        ...
        return new ResponseMessage(0, "실종자 삭제가 완료되었습니다.");
    }
}

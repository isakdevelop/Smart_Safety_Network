package com.smartsafetynetwork.api.repository.criminalBoard;
...
public interface CriminalBoardRepository extends JpaRepository<CriminalBoard, String> {
    @Query("select new com.smartsafetynetwork.api.dto.criminalBoard.response.CriminalBoardListDto(" +
    ...
    @Query("select new com.smartsafetynetwork.api.dto.criminalBoard.response.CBResponseDto(" +

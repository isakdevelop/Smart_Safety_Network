...
public interface CriminalRepository extends JpaRepository<Criminal, String> {
    @Query("select new com.smartsafetynetwork.api.criminal.dto.response.CriminalListResponseDto(" +
    ...
    @Query("select new com.smartsafetynetwork.api.criminal.dto.response.CriminalDetailResponseDto("
